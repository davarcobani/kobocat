...
ENKETO_URL = os.environ.get('ENKETO_URL', 'https://enketo.globalarastirma.com')
KOBOCAT_URL = os.environ.get('KOBOCAT_URL', 'https://kc.globalarastirma.com')
...
KOBOCAT_PUBLIC_HOSTNAME = "{}.{}".format(
    os.environ.get("KOBOCAT_PUBLIC_SUBDOMAIN", "kc"),
    os.environ.get("PUBLIC_DOMAIN_NAME", "globalarastirma.com"))
