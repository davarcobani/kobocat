...
class Command(BaseCommand):
    ...
    https://github.com/davarcobani/kobocat/issues/222 and
    https://github.com/davarcobani/kobocat/issues/358. See also
    https://github.com/davarcobani/kobocat/issues/242. '''
